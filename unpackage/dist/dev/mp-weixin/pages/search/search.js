...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const historySearch = common_vendor.ref(common_vendor.index.getStorageSync("historyStorage") || []);
    ...
    const onSearch = () => {
      ...
      common_vendor.index.setStorageSync("historyStorage", historySearch.value);
    ...
    const searchWall = async () => {
      try {
        const res = await api_apis.apiSearchWall(queryParams.value);
    ...
    const removeHistory = () => {
      common_vendor.index.showModal({
        ...
        success: (res) => {
          if (res.confirm) {
            common_vendor.index.removeStorageSync("historyStorage");
            historySearch.value = [];
          }
        }
      });
